...
import ir.jahanmir.araxx.adapter.AdapterConnection;
import ir.jahanmir.araxx.adapter.AdapterSpinnerNetType;
...
import ir.jahanmir.araxx.enums.EnumNetType;
...
import ir.jahanmir.araxx.model.NetType;
...
//        });
    ...
    private void initToolbar() {
        ...
        layToolbarMain.setBackgroundColor(getResources().getColor(R.color.color_connections));
        imgIcon.setImageResource(R.drawable.ic_connections);
        txtName.setText(" ریز مصرف");
